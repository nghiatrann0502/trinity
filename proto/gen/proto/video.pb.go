...
func (x *VideoDetail) GetDescription() string {
	if x != nil {
...
func (x *VideoDetail) GetUrl() string {
	if x != nil {
		return x.Url
	}
	return ""
...
func (x *VideoDetail) GetThumbnail() string {
	if x != nil {
		return x.Thumbnail
	}
	return ""
...
func (x *VideoDetail) GetDuration() int64 {
	if x != nil {
		return x.Duration
	}
	return 0
...
type VideoList struct {
	...
	Videos []*VideoDetail `protobuf:"bytes,1,rep,name=videos,proto3" json:"videos,omitempty"`
}
...
func (x *VideoList) GetVideos() []*VideoDetail {
	if x != nil {
		return x.Videos
	}
	return nil
...
type VideoResponse struct {
	...
	Video *VideoDetail `protobuf:"bytes,1,opt,name=video,proto3" json:"video,omitempty"`
}
...
func (x *VideoResponse) GetVideo() *VideoDetail {
	if x != nil {
		return x.Video
	}
	return nil
...
var file_proto_video_proto_rawDesc = []byte{
	...
	0x6f, 0x74, 0x6f, 0x22, 0xa1, 0x01, 0x0a, 0x0b, 0x56, 0x69, 0x64, 0x65, 0x6f, 0x44, 0x65, 0x74,
	...
	0x72, 0x6c, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x75, 0x72, 0x6c, 0x12, 0x1c, 0x0a,
	...
	0x75, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x22, 0x31, 0x0a, 0x09, 0x56, 0x69, 0x64, 0x65, 0x6f,
	0x4c, 0x69, 0x73, 0x74, 0x12, 0x24, 0x0a, 0x06, 0x76, 0x69, 0x64, 0x65, 0x6f, 0x73, 0x18, 0x01,
	0x20, 0x03, 0x28, 0x0b, 0x32, 0x0c, 0x2e, 0x56, 0x69, 0x64, 0x65, 0x6f, 0x44, 0x65, 0x74, 0x61,
	0x69, 0x6c, 0x52, 0x06, 0x76, 0x69, 0x64, 0x65, 0x6f, 0x73, 0x22, 0x23, 0x0a, 0x0f, 0x47, 0x65,
	...
	0x1e, 0x0a, 0x0c, 0x56, 0x69, 0x64, 0x65, 0x6f, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12,
	...
	,
}
...
var file_proto_video_proto_goTypes = []interface{}{
	(*VideoDetail)(nil),     // 0: VideoDetail
	(*VideoList)(nil),       // 1: VideoList
	(*GetByIDsRequest)(nil), // 2: GetByIDsRequest
	(*VideoRequest)(nil),    // 3: VideoRequest
	(*VideoResponse)(nil),   // 4: VideoResponse
}
var file_proto_video_proto_depIdxs = []int32{
	0, // 0: VideoList.videos:type_name -> VideoDetail
	0, // 1: VideoResponse.video:type_name -> VideoDetail
	2, // 2: VideoService.GetByIDs:input_type -> GetByIDsRequest
	3, // 3: VideoService.GetByID:input_type -> VideoRequest
	1, // 4: VideoService.GetByIDs:output_type -> VideoList
	4, // 5: VideoService.GetByID:output_type -> VideoResponse
